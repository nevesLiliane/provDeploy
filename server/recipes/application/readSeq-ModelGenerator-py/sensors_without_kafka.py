...
def build_and_start_scheduler():
    ...
    sched.add_job(collect_and_dispatch, 'interval', seconds=args.collect_interval, max_instances=1, id='job',timezone=utc)
    # if args.timeout:
...
if __name__ == '__main__':
    ...
    producer = open(args.filename+"/telemetria.txt", 'w')
