...
CREATE FUNCTION insertPerformance (vtask_id INTEGER, vsubtask_id INTEGER, vmethod VARCHAR(30), vdeion VARCHAR(200), vstarttime VARCHAR(30), vendtime VARCHAR(30), vinvocation TEXT)
RETURNS INTEGER
BEGIN
	DECLARE vid INTEGER;
    ...
    IF(vid IS NULL) THEN
    	...
    	INSERT INTO performance(id,task_id,subtask_id,method,deion,starttime,endtime,invocation) VALUES (vid,vtask_id,vsubtask_id,vmethod,vdeion,vstarttime,vendtime,vinvocation);
	ELSE
    	UPDATE performance
